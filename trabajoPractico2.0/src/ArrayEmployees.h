 ...
 * \param
 * \param
 * \return int Return 0 there's an error or 1 if ok
 *
 */
int createEmployee(Employee* emp, int* pId);
 ...
 *
 * \param option char
 * \return Return 0 there's an error or 1 if ok
 *
 */
